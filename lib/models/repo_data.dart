...
List<RepoData> repoDataFromJson(String str) => List<RepoData>.from(json.decode(str).map((x) => RepoData.fromJson(x)));

String repoDataToJson(List<RepoData> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class RepoData {
  ...
  factory RepoData.fromJson(Map<String, dynamic> json) => RepoData(
    ...
    language: json["language"] ?? "Unknown lang",
