        ...
        children: [
          ...
          ZoomIn(
            ...
            child: const Padding(
              ...
              child: CrazySeoText(
                text:
                    "I am Bibek from Odisha interested in app development be it"
                  ...
                  ClipRect(
                    child: BackdropFilter(
                      ...
                      child: Container(
                        ...
                        padding: const EdgeInsets.all(10),
                        width:
                            size.width > 800 ? size.width * 0.47 : size.width,
                        child: Column(
                          children: [
                            Row(
                              children: const [
                              ...
                              children: [
                                ...
                                SizedBox(
                                    ...
                                    child: CrazySeoImage(
                                        ...
                                        child:
                                            Image.asset(AssetAssets.iconJava))),
                                SizedBox(
                                    width: 50,
                                    height: 50,
                                    child: CrazySeoImage(
                                ...
                                SizedBox(
                                    ...
                                    child: CrazySeoImage(
                                        ...
                                        child:
                                            Image.asset(AssetAssets.iconGIT))),
                                SizedBox(
                                    width: 50,
                                    height: 50,
                                    child: CrazySeoImage(
                                ...
                                SizedBox(
                                    ...
                                    child: CrazySeoImage(
                                        ...
                                        child:
                                            Image.asset(AssetAssets.iconDart))),
                              ],
                            )
                          ],
                        ),
